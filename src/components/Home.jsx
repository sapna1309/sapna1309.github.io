...
const Home = () => {
  ...
  return (
    <div
      name="home"
      className="max-w-screen md:w-xl  mx-auto pt-10 md:pt-28 bg-gradient-to-b from-black via-black to-gray-800  "
    >
      <div className="max-w-screen-lg md:max-w-screen-xl border-0 mx-auto grid lg:grid-cols-2 items-center justify-center">
        <div
          className="px-8 py-12 max-w-lg mx-auto sm:max-w-xl border-0 lg:px-12 lg:py-24 lg:max-w-full"
          data-aos="fade-right"
        >
          <h2 style={{ fontSize: 30, fontWeight: 600, color: "white" }}>
            Hi, my name is,
          </h2>
          <h2 className=" text-6xl text-teal-200 font-bold animate-none md:animate-pulse z-0 ">
            Sapna Sharma{" "}
          </h2>
          ...
          <p className="text-white font-normal text-lg  py-4 font-medium max-w-screen-sm">
            ...
            >
              ...
              <div>
                <a
                  ...
                  download={"Sapna-Sharma-Resume.pdf"}
                  onClick={()=>{
        ...
        <img
          className="mx-auto rounded-2xl w-8/12 object-cover object-center md:w-8/12  lg:w-6/11 ring ring-4 ring-teal-200 hover:ring-blue-400 "
          src={HeroImage}
          alt="Profile-Pic"
          data-aos="fade-left"
        />
