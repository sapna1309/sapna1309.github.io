...
const Home = () => {
  ...
  return (
    <div
      name="home"
      className="max-w-screen w-full  mx-auto pt-10 md:pt-28 bg-gradient-to-b from-black via-black to-gray-800  "
    >
      <div className="max-w-screen max-w-screen-lg  mx-auto grid lg:grid-cols-2 items-center">
    ...
    <img className="mx-auto rounded-2xl w-8/12 object-cover object-center md:w-8/12  lg:w-8/12 " src={HeroImage} alt="logo" data-aos="fade-left" />
      </div>
    </div>
  );
};
