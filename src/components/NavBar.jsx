    ...
    <div className=" max-w-screen mx-auto flex justify-evenly items-center w-full h-20 px-4 py-1 text-white bg-black fixed z-20">
      ...
      <ul className="hidden md:flex">
        {links.map(({ id, link }) => (
          <li
            key={id}
            className="px-4 cursor-pointer capitalize font-medium text-lg text-gray-400 hover:scale-105 hover:text-blue-500 duration-300"
          >
      ...
      <div
        onClick={() => setNav(!nav)}
        className="cursor-pointer pr-20 z-10  text-gray-400 md:hidden"
      >
